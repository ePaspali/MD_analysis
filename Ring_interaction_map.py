...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 18:01:52 2025
...
img = plt.imshow(contact_map, cmap='viridis', interpolation='nearest', vmin=0, vmax=np.max(contact_map),
                 extent=[0, len(residues), 0, len(residues)], origin='lower', aspect='auto')
plt.colorbar()
